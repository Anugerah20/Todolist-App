...
function ListTodo() {
  return (
    <main className="font-sansPro text-center md:text-center inline ">
      {/* START: Filter Button */}
      <section className="font-sansPro flex sm:flex justify-center sm:justify-start md:justify-center items-center  md:items-center sm:items-center mx-0 sm:mx-[27rem] md:mx-auto mt-4 sm:mt-2 md:mt-2 lg:mt-2">
